...
There are several ways you can contribute to DeOCR:
...
[1st-issue]: https://github.com/Moenupa/DeOCR/contribute
[2nd-issue]: https://github.com/Moenupa/DeOCR/labels/Good%20Second%20Issue
[prj]: https://github.com/Moenupa/DeOCR
[prj-fork]: https://github.com/Moenupa/DeOCR/fork

### Style guide

DeOCR follows the [Google Python Style Guide][google-python-styleguide] and 
...
1. Fork the [repository][prj] by clicking on the [Fork][prj-fork] button on the repository's page. This creates a copy of the code under your GitHub user account.
2. Clone your fork to your local disk, and add the base repository as a remote:
    ```bash
    git clone git@github.com:<your Github handle>/DeOCR.git
    cd DeOCR
    git remote add upstream https://github.com/Moenupa/DeOCR.git
    ```
...
7. Create a pull request from your branch `feat/describe_your_changes` at [origin repo][prj].